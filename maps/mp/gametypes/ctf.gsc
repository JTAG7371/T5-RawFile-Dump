...
ctf_gamemodeSpawnDvars()
{
	...
	ss.ctf_friendly_base_influencer_radius =	set_dvar_float_if_unset("scr_spawn_ctf_friendly_base_influencer_radius", "" + 15.0*get_player_height());
	...
	ss.ctf_enemy_base_influencer_radius =	set_dvar_float_if_unset("scr_spawn_ctf_enemy_base_influencer_radius", "" + 15.0*get_player_height());
	
	// ctf: negative influencer around carrier
	ss.ctf_enemy_carrier_influencer_score =	set_dvar_float_if_unset("scr_spawn_ctf_enemy_carrier_influencer_score", "0");
	ss.ctf_enemy_carrier_influencer_score_curve =	set_dvar_if_unset("scr_spawn_ctf_enemy_carrier_influencer_score_curve", "constant");
	ss.ctf_enemy_carrier_influencer_radius =	set_dvar_float_if_unset("scr_spawn_ctf_enemy_carrier_influencer_radius", "" + 10.0*get_player_height());
	
	ss.ctf_friendly_carrier_influencer_score =	set_dvar_float_if_unset("scr_spawn_ctf_friendly_carrier_influencer_score", "0");
	ss.ctf_friendly_carrier_influencer_score_curve =	set_dvar_if_unset("scr_spawn_ctf_friendly_carrier_influencer_score_curve", "constant");
	ss.ctf_friendly_carrier_influencer_radius =	set_dvar_float_if_unset("scr_spawn_ctf_friendly_carrier_influencer_radius", "" + 8.0*get_player_height());
	
	ss.ctf_dropped_influencer_score =	set_dvar_float_if_unset("scr_spawn_ctf_dropped_influencer_score", "0");
	ss.ctf_dropped_influencer_score_curve =	set_dvar_if_unset("scr_spawn_ctf_dropped_influencer_score_curve", "constant");
	ss.ctf_dropped_influencer_radius =	set_dvar_float_if_unset("scr_spawn_ctf_dropped_influencer_radius", "" + 10.0*get_player_height());
}

...
main()
{
	...
	self.headModel = codescripts\character::randomElement(xmodelalias\c_rus_spetsnaz_rebirth_head_char_alias::main());
...
precache()
{
	...
	codescripts\character::precacheModelArray(xmodelalias\c_rus_spetsnaz_rebirth_head_char_alias::main());

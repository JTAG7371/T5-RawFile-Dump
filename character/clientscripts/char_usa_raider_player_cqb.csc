...
matches_me()
{
	if(self.model == "char_usa_raider_player_body_cqb")
	{
		return true;
	}
	return(false);
...
register_gibs()
{
	...
	gib_spawn.gibSpawn3 = "char_usa_marine_body2_m_g_rlegspawn";
	gib_spawn.gibSpawnTag3 = "J_Knee_RI";
	gib_spawn.gibSpawn4 = "char_usa_marine_body2_m_g_llegspawn";

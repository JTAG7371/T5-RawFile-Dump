...
matches_me()
{
	if(self.model == "char_ger_hnrgd_player_body_assault")
	{
		return true;
	}
	return(false);
...
register_gibs()
{
	...
	gib_spawn.gibSpawn1 = "char_ger_wermacht_body1_m_g_rarmspawn";
	gib_spawn.gibSpawnTag1 = "J_Elbow_RI";
	gib_spawn.gibSpawn2 = "char_ger_wermacht_body1_m_g_larmspawn";
	gib_spawn.gibSpawnTag2 = "J_Elbow_LE";
	gib_spawn.gibSpawn3 = "char_ger_wermacht_body1_m_g_rlegspawn";
	gib_spawn.gibSpawnTag3 = "J_Knee_RI";
	gib_spawn.gibSpawn4 = "char_ger_wermacht_body1_m_g_llegspawn";

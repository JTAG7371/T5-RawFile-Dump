...
main()
{
	self setModel("c_ger_infantry_body_char");
	self.headModel = codescripts\character::randomElement(xmodelalias\c_ger_infantry_head_char_alias::main());
	self attach(self.headModel, "", true);
	self.hatModel = "c_ger_infantry_helm_char";
	self attach(self.hatModel);
	self.gearModel = "c_ger_infantry_gear_char";
...
precache()
{
	precacheModel("c_ger_infantry_body_char");
	codescripts\character::precacheModelArray(xmodelalias\c_ger_infantry_head_char_alias::main());
	precacheModel("c_ger_infantry_helm_char");
	precacheModel("c_ger_infantry_gear_char");
